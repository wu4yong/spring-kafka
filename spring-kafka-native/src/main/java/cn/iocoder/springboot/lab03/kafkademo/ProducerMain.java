...
public class ProducerMain {
    ...
    private static Producer<String, String> createProducer() {
        ...
        properties.put("bootstrap.servers", "114.115.138.227:9092"); // 设置 Broker 的地址
        properties.put("acks", "1"); // 0-不应答。1-leader 应答。all-所有 leader 和 follower 应答。
        properties.put("retries", 3); // 发送失败时，重试发送的次数
//        properties.put("batch.size", 16384);//【数量】batch-size ：超过收集的消息数量的最大条数。
//        properties.put("linger.ms", 1);//【时间】linger.ms ：超过收集的时间的最大等待时长，单位：毫秒
//        properties.put("client.id", "DemoProducer");
//        properties.put("buffer.memory", 33554432);//【空间】buffer-memory ：超过收集的消息占用的最大内存。
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        ProducerRecord<String, String> message = new ProducerRecord<>("demo_01_topic", "key", "I'm is a kafka message!");
